    ...
    <div className="pt-32 pb-24 min-h-screen bg-white text-black">
      <div className="container mx-auto px-6 md:px-12">
        ...
        <div className="relative w-full h-[60vh] min-h-[400px] rounded-[40px] overflow-hidden mb-16">
          <Image src="/aboutphoto.jpeg" alt="Ashirvad Resort wayanad - About Ashirvadh" fill priority sizes="100vw" className="object-cover" />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="relative h-64 rounded-2xl overflow-hidden mt-8">
              <Image src="/exp-room.jpg" alt="Ashirvad Resort wayanad - Nature" fill sizes="(max-width: 768px) 50vw, 33vw" className="object-cover" />
            </div>
            <div className="relative h-64 rounded-2xl overflow-hidden">
              <Image src="/exp-amphi1.jpg" alt="Ashirvad Resort wayanad - Comfort" fill sizes="(max-width: 768px) 50vw, 33vw" className="object-cover" />
            </div>
          </div>
        </div>
      </div>
