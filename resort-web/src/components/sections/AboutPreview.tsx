    ...
    <section className="relative bg-[#f8f6f0] rounded-[40px] md:rounded-[60px] p-8 md:p-16 lg:p-20 grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center text-[#2b3a2a] overflow-hidden">
      ...
      >
        ...
        <div className="md:absolute -bottom-10 left-1/2 md:-translate-x-1/2 w-full md:w-[110%] bg-[#283627] text-[#f8f6f0] rounded-2xl md:rounded-[24px] p-5 md:p-6 shadow-xl z-20">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-0 md:divide-x divide-white/20">
            {/* Feature 1 */}
            <div className="flex items-center gap-3 px-2 md:px-4">
              ...
              <p className="text-xs font-medium leading-tight text-white/90">Nature<br/>Immersed</p>
            </div>
            {/* Feature 2 */}
            <div className="flex items-center gap-3 px-2 md:px-4">
              <div className="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center shrink-0">
              ...
              <p className="text-xs font-medium leading-tight text-white/90">Scenic<br/>Landscapes</p>
            </div>
            {/* Feature 3 */}
            <div className="flex items-center gap-3 px-2 md:px-4">
              <div className="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center shrink-0">
              ...
              <p className="text-xs font-medium leading-tight text-white/90">Peaceful<br/>Retreat</p>
            </div>
            {/* Feature 4 */}
            <div className="flex items-center gap-3 px-2 md:px-4">
              <div className="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center shrink-0">
              ...
              <p className="text-xs font-medium leading-tight text-white/90">Personalized<br/>Comfort</p>
            </div>
          </div>
        </div>
      </motion.div>
