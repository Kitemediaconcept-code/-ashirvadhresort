        ...
        <div className="md:absolute -bottom-10 left-1/2 md:-translate-x-1/2 w-full md:w-[110%] bg-[#283627] text-[#f8f6f0] rounded-2xl md:rounded-[24px] p-5 md:p-6 shadow-xl z-20">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-y-6 gap-x-2 md:gap-0 md:divide-x divide-white/20">
            ...
            <div className="flex items-center justify-start gap-2 md:gap-3 md:px-4">
              ...
              <p className="text-xs sm:text-sm md:text-xs font-medium leading-tight text-white/90 text-left">Nature<br/>Immersed</p>
            </div>
            {/* Feature 2 */}
            <div className="flex items-center justify-start gap-2 md:gap-3 md:px-4">
              <div className="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center shrink-0">
              ...
              <p className="text-xs sm:text-sm md:text-xs font-medium leading-tight text-white/90 text-left">Scenic<br/>Landscapes</p>
            </div>
            {/* Feature 3 */}
            <div className="flex items-center justify-start gap-2 md:gap-3 md:px-4">
              <div className="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center shrink-0">
              ...
              <p className="text-xs sm:text-sm md:text-xs font-medium leading-tight text-white/90 text-left">Peaceful<br/>Retreat</p>
            </div>
            {/* Feature 4 */}
            <div className="flex items-center justify-start gap-2 md:gap-3 md:px-4">
              <div className="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center shrink-0">
              ...
              <p className="text-xs sm:text-sm md:text-xs font-medium leading-tight text-white/90 text-left">Personalized<br/>Comfort</p>
            </div>
          </div>
        </div>
      </motion.div>
